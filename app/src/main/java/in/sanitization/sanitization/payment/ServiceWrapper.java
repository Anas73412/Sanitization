package in.sanitization.sanitization.payment;
...
import in.sanitization.sanitization.BuildConfig;
import in.sanitization.sanitization.Config.BaseUrl;
import in.sanitization.sanitization.Config.Constants;
...
//            HttpLoggingInterceptor loggingInterceptor = new HttpLoggingInterceptor();
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(BaseUrl.PAYMENT_BASE_URL)
