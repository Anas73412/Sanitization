...
public class OrderModel {
    ...
    public String getDisinfection_charge() {
        return disinfection_charge;
    }

    public void setDisinfection_charge(String disinfection_charge) {
        this.disinfection_charge = disinfection_charge;
    }
