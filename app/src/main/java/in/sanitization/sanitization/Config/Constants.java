...
/**
 * Developed by Binplus Technologies pvt. ltd.  on 08,June,2020
 */
public class Constants {
    static final String APP_NAME = "A2ZIndia";
    public static final String PREFS_NAME = "A2ZLoginPrefs";
    public static final String PREFS_NAME2 = "A2ZLoginPrefs2";
